...
mongoose.connect('mongodb+srv://deven3977:ecommerce@cluster0.nfzqfqy.mongodb.net/e-commerce', {
...
app.post('/signup', async (req, res)=>{
    ...
    if(check){
        return res.status(400).json({succes:false, error:"Existing user found with the same email address."});
    }
    let cart = {};
    for(let i=0; i<300; i++){
        cart[i]=0;
...
app.get('/newcollections', async(req, res)=>{
 ...
 //creating end point popular in womens  section
 ...
 //creating endpoint to remove item form cratdata
